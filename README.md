...
## 1. 프로젝트 개요
### **1️⃣ 프로젝트 목적**
폰고 서비스 사용자의 견적 요청 및 거래 예약 전환율 증가시키기 
...
<img width="695" alt="image" src="https://user-images.githubusercontent.com/106254025/211472884-b7063f8e-cd30-4cc5-92b1-f40bf21ed7f4.png">
...
- 코호트별 전환율 분석
   - 폰고 사용자 데이터 EDA를 통해 '전자기기 상태 등급'과 '견적요청 시간' 2가지 코호트에서 거래 예약 전환율 차이가 존재함을 확인하였습니다. 기존 마케팅 및 이벤트의 사용자 타기팅이 적절했는지를 검토한 후 거래 예약 전환율이 높은 코호트를 중심으로 서비스 개선을 제안하였습니다.
